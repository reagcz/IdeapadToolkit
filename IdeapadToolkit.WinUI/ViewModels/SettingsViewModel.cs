...
internal class Settings
{
    ...
    private static readonly string _path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "IdeapadToolkit", "settings.txt");
    ...
    public void Save()
    {
        File.WriteAllText(_path, $"{Language};{KeepInTray}");
    }
